...
class OrderServiceTest {
    ...
    public void 상품주문() throws Exception{
        ...
        Item book = createBook("Spring JPA", 10000, 10);
    ...
    private Member createMember() {
        ...
        member.setName("회원1");
        member.setAddress(new Address("스울","강가","123-123"));
        em.persist(member);
        return member;
    }
    ...
    public void 주문취소() throws Exception{
        ...
        assertEquals(10, book.getStockQuantity(),"주문 취소시 상품은 그만큼 재고가 증가해야한다.");
    }
